...
This is the same pattern I use across my projects — treat content as data, not as UI. The UI is just a view function over data. Seasonly's guarded write vocabulary and Brume's rate-limit rules both follow this philosophy.
